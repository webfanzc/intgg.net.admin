...
exports.findById = function(_id,callback){
    Droppacks.findById(_id,function(err,doc){
        if(err){
            callback(err);
            return;
        }
...
exports.getList = function (conditions, fields, page, callback) {
    ...
    async.auto({
        findItems: function (callback) {
            var query = Droppacks.find(conditions, fields || "-__v")
                .lean()
                .populate({
                    path: 'intid',
                    select: 'nickname'
        ...
        itemCount: function (callback) {
            ...
            Droppacks.count(conditions, function (err, count) {
                callback(err, count);
            });
        }
...
exports.findOne = function (conditions, fields, callback) {
    Droppacks.findOne(conditions, fields || "-__v", function (err, doc) {
        callback(err, doc || {});
    });
};
...
exports.findOneAndUpdate = function (conditions, modifyFields, options, callback) {
    ...
    Droppacks.findOneAndUpdate(conditions, modifyFields, options, function (err, obj) {
        callback(err, obj);
    });
};
...
exports.save = function(obj,callback){
    ...
    var droppack = new Droppacks(obj);
    droppack.save(function(err,doc){
        if(err){
            callback(err);
            return;
        }
...
exports.del = function (condition, options, callback) {
    ...
    Droppacks.findOneAndRemove(condition, options, function (err, doc) {
        callback(err, doc);
    });
};
...
exports.update = function (conditions, fields, options, callback) {
    ...
    Droppacks.findOneAndUpdate(conditions, fields, options, function (err, doc) {
        callback(err, doc);
    });
};